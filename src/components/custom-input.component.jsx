...
const CustomInput = ({ placeholder, ...rest }) => {
    ...
    return (
        <div onClick={focusOnClick} class="relative w-full xl:w-[250px] my-4 mx-2">
            <input ref={inputRef} type="text" {...rest} class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 border-0 border-b-2 border-[#FEBD20] appearance-none  focus:outline-none focus:ring-0 focus:border-black peer" placeholder=" " />
