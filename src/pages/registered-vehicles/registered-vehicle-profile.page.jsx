      ...
      <CustomContainer>
        <div className="flex items-center justify-between mt-10 p-2">
          <div className="flex items-center space-x-2">
            <img
              src={require('../../assets/icons/car-front.png')}
              className="w-[20px] h-[20px] lg:w-[50px] lg:h-[40px]"
              alt=""
            />
        ...
        <div className="flex flex-wrap flex-col md:flex-row xl:flex-row xl:items-center my-4">
          <UserDetailBox
            title="Vehicle Name"
            description={vehicleDetails.name}
          />
          <UserDetailBox title="Vehcile ID" description={id} />
          <UserDetailBox
            title="Vehcile Registration #"
            description={vehicleDetails.registrationNo}
          />
          <UserDetailBox
            title="Vehicle Type"
            description={vehicleDetails.type}
          />
          <UserDetailBox
            title="Renting Price/Day"
            description={'$' + vehicleDetails.price.pricePerDay}
          />
          <UserDetailBox
            title="Vehicle Capacity"
            description={vehicleDetails.capacity}
          />
        </div>
