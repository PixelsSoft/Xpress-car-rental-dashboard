    ...
    const editProfile = async (e) => {
        ...
        try {
            ...
            if (response.data.success === true) {
                ...
                localStorage.setItem('@user_details', JSON.stringify({user: response2.data.data, token: token}))
    ...
    return (
        <>
            <CustomContainer otherStyles='p-4 h-full'>
                <h1 className="font-bold text-sm lg:text-2xl text-black">Profile Setting</h1>
                    ...
                    {loading ? (<Spinner />) : (
                        <>
                            ...
                            <div className="space-y-4">
                                <img src={image ? image : require('../../assets/images/profile-empty.png')} alt="" className="w-40 h-40 border-2 border-gray-600 rounded-full" />
